...
import { AddassociateComponent } from '../addemployee/addemployee.component';
...
import { getassociate, deleteeassociate, loadassociate, openpopup } from 'src/app/Store/Associate/Associate.Action';
...
export class AssociatelistingComponent implements OnInit {
  ...
  FunctionAdd() {
    this.OpenPopup(0, 'Create New Employee');
  }
